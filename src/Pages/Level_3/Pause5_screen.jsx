  ...
  useEffect(() => {
    const handleKeyDown = (e) => {
      if (e.code === 'Space' || e.key === ' ') {
        e.preventDefault();
        if (typingDone) navigate('/level3_5');
      }
    };
      ...
      <div className='story1_center'>
        <div className='loading_screen_div1-1'>
          <div className='loading_screen_div3-1'>
            ...
            >
              "He never stopped performing the rite."<br />
              "He only stopped believing it reached anything."<br />
              "He kept going anyway. For twenty more years."
            </h1>
          </div>
        </div>
      </div>
