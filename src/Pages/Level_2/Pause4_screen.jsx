  ...
  useEffect(() => {
    const handleKeyDown = (e) => {
      if (e.code === 'Space' || e.key === ' ') {
        e.preventDefault();
        if (typingDone) navigate('/level2_game');
      }
    };
      ...
      <div className='story1_center'>
        <div className='loading_screen_div1-1'>
          <div className='loading_screen_div3-1'>
            ...
            >
           "LOOK CLOSLY"<br></br>
           "Each difference you find is a piece of the truth "<br></br>
           "Help her reclaim her work."
            </h1>
          </div>
        </div>
      </div>
