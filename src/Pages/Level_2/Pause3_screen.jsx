  ...
  useEffect(() => {
    const handleKeyDown = (e) => {
      if (e.code === 'Space' || e.key === ' ') {
        e.preventDefault();
        if (typingDone) navigate('/level2_5');
      }
    };
      ...
      <div className='story1_center'>
        <div className='loading_screen_div1-1'>
          <div className='loading_screen_div3-1'>
            ...
            >
           "She kept the evidence."<br></br>
           "She hid it where she knew it would last."<br></br>
           "She waited her entire life for someone to look."
            </h1>
          </div>
        </div>
      </div>
